...
setwd("C:/Users/gavin/OneDrive/Desktop/WorkStuff/bioDS-bootcamp/bioDS-bootcamp-master")

getwd()

df_pheno <- read.csv(file="RNASeqData/phenotypeTable.csv", header =TRUE)
#bioDS-bootcamp/bioDS-bootcamp-master/RNASeqData
...
RNADirectoryList = list.dirs(path = "bioDS-bootcamp/bioDS-bootcamp-master/RNASeqData", recursive = FALSE)
#bioDS-bootcamp/bioDS-bootcamp-master/RNASeqData
```
...
salmonCounts_df <-read.csv(file="bioDS-bootcamp/bioDS-bootcamp-master/RNASeqData/2018-08-06_SalmonGeneLevelCounts.csv", 
                     header =TRUE)
