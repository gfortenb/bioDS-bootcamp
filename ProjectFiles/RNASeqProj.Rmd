...
DESeq2::plotCounts(dseq_set_htseq, "CALR", intgroup = "diagnosis",main = "Presence of CALR Mutation")
...
```
```{r}
DESeq2::plotCounts(dseq_set_salmon, "CALR", intgroup = "diagnosis",main = "Presence of CALR Mutation salmon")

```

```{r}
#corrplot(, method = "color")
#head(df_htseqNsalmon)
...
salmonCounts_df_int <- cbind(salmonCounts_df[ , -25], salmonCounts_genes) # (dont need add column at beginning)
...
colnames(salmon_genecounts_dfLong) <- c("Gene", "molec_ID", "counts") #lowkey sketch process, invesitage later
...
colnames(df_htseqNsalmonLong) <- c("Gene", "molec_ID", "htseq_counts", "salmon_counts") #lowkey sketch process, invesitage later

df_htseqNsalmonLong


#summary tables from this, use sum tables in hand drawn vennD
...
jpeg(file = "L2FC_SUM1.jpeg")
barplot(L2FC_SUM1_mat, main = "Summary of 'HTSEQ' vs. 'SALMON' Log2 Fold Change", xlab = "Tool", ylab = "Number of Genes", col="gold")
dev.off()
